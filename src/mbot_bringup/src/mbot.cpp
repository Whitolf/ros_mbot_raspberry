...
namespace mbot
{
    ...
    boost::array<double, 36> odom_twist_covariance = {
        ...
        0, 0, 0, 0, 1e6, 0, 
        0, 0, 0, 0, 0, 1e-9}};
    mbot::mbot():x_(0.0), y_(0.0), th_(0.0),vx_(0.0), vy_(0.0), vth_(0.0),sensFlag_(0),receFlag_(0) {}//构造函数
    mbot::~mbot(){}                                                                                   //析构函数
    /********************************************************
    ...
    ********************************************************/
    ...
    出口参数：bool
    ********************************************************/
    bool mbot::deal(double RobotV, double RobotYawRate)
    {
